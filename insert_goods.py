...
goods_records = [
    {
        ...
        "stock": 100,
        "stock_warning": 20,
        "img_url": "/static/img/goods/bamboo_cup.jpg",
        "status": "on_shelf"
    },
    {
        "goods_name": "有机棉环保购物袋",
        ...
        "stock": 200,
        "stock_warning": 30,
        "img_url": "/static/img/goods/cotton_bag.jpg",
        "status": "on_shelf"
    },
    {
        "goods_name": "太阳能充电宝",
        ...
        "stock": 50,
        "stock_warning": 10,
        "img_url": "/static/img/goods/solar_powerbank.jpg",
        "status": "on_shelf"
    },
    {
        "goods_name": "可降解餐具套装",
        ...
        "stock": 150,
        "stock_warning": 25,
        "img_url": "/static/img/goods/biodegradable_cutlery.jpg",
        "status": "on_shelf"
    },
    {
        "goods_name": "环保文具礼盒",
        ...
        "stock": 80,
        "stock_warning": 15,
        "img_url": "/static/img/goods/stationery_set.jpg",
        "status": "on_shelf"
    },
    {
        "goods_name": "竹制牙刷套装",
        ...
        "stock": 0,
        "stock_warning": 20,
        "img_url": "/static/img/goods/bamboo_toothbrush.jpg",
        "status": "sold_out"
    },
    {
        "goods_name": "植物基洗衣液",
        ...
        "stock": 60,
        "stock_warning": 15,
        "img_url": "/static/img/goods/plant_detergent.jpg",
        "status": "on_shelf"
    },
    {
        "goods_name": "环保种子卡片",
        ...
        "stock": 300,
        "stock_warning": 50,
        "img_url": "/static/img/goods/seed_card.jpg",
        "status": "on_shelf"
    },
    {
        "goods_name": "不锈钢吸管套装",
        ...
        "stock": 120,
        "stock_warning": 20,
        "img_url": "/static/img/goods/steel_straws.jpg",
        "status": "on_shelf"
    },
    {
        "goods_name": "微纤维清洁布",
        ...
        "stock": 5,
        "stock_warning": 10,
        "img_url": "/static/img/goods/microfiber_cloth.jpg",
        "status": "off_shelf"
    }
]
...
def insert_goods():
    ...
    with app.app_context():
        ...
        for idx, goods in enumerate(Goods.query.all(), 1):
            print(f"{idx}. {goods.goods_name} - {goods.need_points}积分 - 库存:{goods.stock} - 状态:{goods.status}")
